...
function TestReproductive2Section() {
  return (
    <SimpleSection className="mt-10 lg:mt-20 overflow-x-hidden   justify-between">
      <ImageSection
      ...
      <div className="flex flex-col  max-w-lg min-w-[300px] gap-5">
        ...
        <Description fontSize="text-base">
          Take our quiz to assess your knowledge of reproductive health. Answer
          a series of questions and receive instant feedback
        </Description>
...
export default TestReproductive2Section;
