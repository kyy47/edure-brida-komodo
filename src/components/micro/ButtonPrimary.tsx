...
function ButtonPrimary({
  ...
  if (variant === "large-solid") {
    ...
    return (
      <button
        onClick={onClick}
        className="bg-cranberry-600 px-6 py-4 text-white rounded-lg font-normal  w-fit"
      >
        {children}
      </button>
    );
    ...
    return (
      <button
        onClick={onClick}
        className="bg-cranberry-600 px-6 py-3 text-white rounded-lg font-semibold text-sm w-fit"
      >
        {children}
      </button>
    );
